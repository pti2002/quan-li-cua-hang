...
namespace QL_CuaHangTienLoi.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-J787359;Initial Catalog=QL_CUAHANGTIENLOI;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        public static string ThucThiTruyVanScalar(string chuoiTruyVan)
        {
            SqlCommand cm = new SqlCommand(chuoiTruyVan, Functions.Con);
